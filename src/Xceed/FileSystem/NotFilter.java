...
public class NotFilter extends Filter {
  ...
  public void setScopeAsNotFilter(FilterScope value) {
    try {
  ...
  public FilterScope getScopeAsNotFilter() {
    try {
  ...
  public NotFilter(Object filter) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Xceed.FileSystem.NotFilter", filter);
  ...
  public NotFilter(NObject handle) {
    super(handle);
  ...
  public java.lang.Boolean NotFilter___IsItemMatching(FileSystemItem item) {
    try {
