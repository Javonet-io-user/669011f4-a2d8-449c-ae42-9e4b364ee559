...
public class AndFilter extends Filter {
  ...
  public void setScopeAsAndFilter(FilterScope value) {
    try {
  ...
  public FilterScope getScopeAsAndFilter() {
    try {
  ...
  public AndFilter(Object[] filters) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Xceed.FileSystem.AndFilter", new Object[] {filters});
  ...
  public AndFilter(NObject handle) {
    super(handle);
  ...
  public java.lang.Boolean AndFilter___IsItemMatching(FileSystemItem item) {
    try {
