...
public class OrFilter extends Filter {
  ...
  public void setScopeAsOrFilter(FilterScope value) {
    try {
  ...
  public FilterScope getScopeAsOrFilter() {
    try {
  ...
  public OrFilter(Object[] filters) {
    super((NObject) null);
    try {
      javonetHandle = Javonet.New("Xceed.FileSystem.OrFilter", new Object[] {filters});
  ...
  public OrFilter(NObject handle) {
    super(handle);
  ...
  public java.lang.Boolean OrFilter___IsItemMatching(FileSystemItem item) {
    try {
