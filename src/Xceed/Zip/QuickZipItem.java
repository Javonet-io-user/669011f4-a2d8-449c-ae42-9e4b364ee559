...
public class QuickZipItem extends AbstractQuickActionItem {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.Byte getCompressionRatio() {
    try {
      java.lang.Byte res = javonetHandle.get("CompressionRatio");
  ...
  public QuickZipItem(NObject handle) {
    super(handle);
