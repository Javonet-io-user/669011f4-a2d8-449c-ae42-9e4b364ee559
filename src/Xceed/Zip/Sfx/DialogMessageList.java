...
public class DialogMessageList extends NotifyListBase implements IList, ICollection, IEnumerable {
  protected NObject javonetHandle;
  /** SetProperty */
  @MethodTypeAnnotation(type = "Method")
  public void setItem(DialogMessages index, java.lang.String value) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.String getItem(DialogMessages index) {
    try {
  ...
  public java.lang.Boolean getIsFixedSizeAsDialogMessageList() {
    try {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.Boolean getIsReadOnlyAsDialogMessageList() {
    try {
      java.lang.Boolean res =
  ...
  public DialogMessageList(NObject handle) {
    super(handle);
  ...
  @MethodTypeAnnotation(type = "Method")
  public DialogMessages IndexOf(java.lang.String value) {
    try {
      Object res = javonetHandle.invoke("IndexOf", value);
      if (res == null) return null;
      return DialogMessages.valueOf(((NEnum) res).getValueName());
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
