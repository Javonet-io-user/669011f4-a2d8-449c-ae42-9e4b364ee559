...
public class DialogStringList extends NotifyListBase implements IList, ICollection, IEnumerable {
  protected NObject javonetHandle;
  /** SetProperty */
  @MethodTypeAnnotation(type = "Method")
  public void setItem(DialogStrings index, java.lang.String value) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.String getItem(DialogStrings index) {
    try {
  ...
  public java.lang.Boolean getIsFixedSizeAsDialogStringList() {
    try {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.Boolean getIsReadOnlyAsDialogStringList() {
    try {
      java.lang.Boolean res =
  ...
  public DialogStringList(NObject handle) {
    super(handle);
  ...
  @MethodTypeAnnotation(type = "Method")
  public DialogStrings IndexOf(java.lang.String value) {
    try {
      Object res = javonetHandle.invoke("IndexOf", value);
      if (res == null) return null;
      return DialogStrings.valueOf(((NEnum) res).getValueName());
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
