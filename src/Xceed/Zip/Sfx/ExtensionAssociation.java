...
public class ExtensionAssociation {
  ...
  public void setExtension(java.lang.String value) {
    try {
      javonetHandle.set("Extension", value);
  ...
  public void setApplication(java.lang.String value) {
    try {
      javonetHandle.set("Application", value);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }
  ...
  public ExtensionAssociation(
    ...
    try {
      javonetHandle =
          Javonet.New("Xceed.Zip.Sfx.ExtensionAssociation", extension, application, description);
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
    }
  }

  public ExtensionAssociation(NObject handle) {
