...
public class RegistryKeyList extends NotifyListBase implements IList, ICollection, IEnumerable {
  protected NObject javonetHandle;
  /** GetProperty */
  @MethodTypeAnnotation(type = "Method")
  public RegistryKey getItem(java.lang.Integer index) {
    try {
  ...
  public java.lang.Boolean getIsFixedSizeAsRegistryKeyList() {
    try {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public java.lang.Boolean getIsReadOnlyAsRegistryKeyList() {
    try {
      java.lang.Boolean res =
  ...
  public RegistryKeyList(NObject handle) {
    super(handle);
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Boolean Contains(RegistryKey value) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Integer IndexOf(RegistryKey value) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public void Insert(java.lang.Integer index, RegistryKey value) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public void Remove(RegistryKey value) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Integer Add(RegistryKey value) {
    try {
  ...
  @MethodTypeAnnotation(type = "Method")
  public java.lang.Integer Add(java.lang.String keyName, java.lang.String valueName, Object value) {
    try {
      java.lang.Integer res = javonetHandle.invoke("Add", keyName, valueName, value);
      if (res == null) return 0;
      return res;
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
