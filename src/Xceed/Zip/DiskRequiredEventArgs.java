...
public class DiskRequiredEventArgs extends FileSystemEventArgs {
  protected NObject javonetHandle;
  /** GetProperty */
  @MethodTypeAnnotation(type = "GetField")
  public DiskRequiredReason getReason() {
    try {
      Object res = javonetHandle.<NEnum>get("Reason");
      if (res == null) return null;
      return DiskRequiredReason.valueOf(((NEnum) res).getValueName());
  ...
  @MethodTypeAnnotation(type = "SetField")
  public void setAction(DiskRequiredAction value) {
    try {
  ...
  @MethodTypeAnnotation(type = "GetField")
  public DiskRequiredAction getAction() {
    try {
      Object res = javonetHandle.<NEnum>get("Action");
      if (res == null) return null;
      return DiskRequiredAction.valueOf(((NEnum) res).getValueName());
    } catch (JavonetException _javonetException) {
      _javonetException.printStackTrace();
      return null;
    }
  ...
  public DiskRequiredEventArgs(NObject handle) {
    super(handle);
